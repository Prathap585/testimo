      ...
      <section className="py-20 bg-gradient-to-br from-muted/50 to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              <div className="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Simply enter your client's name and email address. Set up your
                  project details and customize the testimonial request message
            ...
            {/* Step 2 */}
            <div
              className="flex flex-col lg:flex-row-reverse items-center mb-20"
              data-testid="step-2"
            >
              <div className="lg:w-1/2 lg:pl-12 mb-8 lg:mb-0">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-bold text-foreground">
                    We send automated requests
                  </h2>
                </div>
                <p className="text-lg text-muted-foreground mb-6">
                  Testimo automatically sends personalized testimonial requests
                  to your clients at the perfect time. Smart follow-ups ensure
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-muted/30 p-3 rounded text-xs">
                        ...
                        <div className="text-muted-foreground mb-2">
                          Hi Sarah! We'd love your feedback on our recent
                          website redesign project...
                        </div>
                        <div className="text-primary">
                          🔗 Share your testimonial (2 min)
                        </div>
                      </div>
            ...
            >
              <div className="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Your clients receive a beautiful, branded form that's
                  mobile-friendly and easy to complete. They can submit text or
                  video testimonials in just minutes.
                </p>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-center">
                    <CheckCircle className="w-4 h-4 text-primary mr-3" />
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="bg-muted/30 p-3 rounded text-xs text-muted-foreground">
                          "The team delivered an amazing website that exceeded
                          our expectations. Professional, timely, and great
            ...
            >
              <div className="lg:w-1/2 lg:pl-12 mb-8 lg:mb-0">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  Review and approve testimonials in your dashboard. Once
                  approved, they automatically appear on your testimonial wall
                  and can be embedded anywhere on your website.
                </p>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-center">
                    <CheckCircle className="w-4 h-4 text-primary mr-3" />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-700">
                          ...
                          <div className="text-xs text-green-700 dark:text-green-300">
                            "Amazing website that exceeded expectations..."
                          </div>
                        </div>
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-700">
                          ...
                          <div className="text-xs text-yellow-700 dark:text-yellow-300">
                            "Professional team, great communication..."
                          </div>
                        </div>
                      </div>
          ...
          <div className="text-center mt-20">
            ...
            >
              Join the businesses who are already automating their testimonial
              collection process with Testimo.
            </p>
            <Button
